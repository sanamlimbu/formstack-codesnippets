...
weekOneStartHourMonday.addEventListener("change", calculateWorkingHoursWeekOne);
...
weekOneEndMinuteMonday.addEventListener("change", calculateWorkingHoursWeekOne);
...
weekOneEndHourTuesday.addEventListener("change", calculateWorkingHoursWeekOne);
...
let weekOneWednesdayLunchBreakField = document.getElementById("field153914237");
...
let weekOneThursdayLunchBreakField = document.getElementById("field153914246");
...
weekOneEndHourThursday.addEventListener("change", calculateWorkingHoursWeekOne);
...
weekOneEndMinuteFriday.addEventListener("change", calculateWorkingHoursWeekOne);

let weekOneSaturdayLunchBreakField = document.getElementById("field153914261");
...
weekOneEndHourSaturday.addEventListener("change", calculateWorkingHoursWeekOne);
...
weekOneStartHourSunday.addEventListener("change", calculateWorkingHoursWeekOne);
